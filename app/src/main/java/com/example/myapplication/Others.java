...
public class Others extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Addenter = (Button) findViewById(R.id.bother);
        edenter = (EditText) findViewById(R.id.other);
        tv = (TextView) findViewById(R.id.tvother);
        btview = (Button) findViewById(R.id.bvother);
        AddData();
       // view();
        ...
        Addenter.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        boolean isInserted7 = db.insertData7(edenter.getText().toString());

                        if (isInserted7 == true) {
                            Toast.makeText(Others.this, "Data Inserted", Toast.LENGTH_LONG).show();
        ...
        btview.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (res.getCount() == 0) {
                            // show message
                            Toast.makeText(Others.this, "Nothing found", Toast.LENGTH_LONG).show();
                            return;
                        }
