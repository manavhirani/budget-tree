    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent I = new Intent("com.example.myapplication.Link");
                        startActivity(I);
                } else {
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent I = new Intent("com.example.myapplication.MainActivity");
                startActivity(I);
            }
        });
                    ...
                    firebaseAuth.signInWithEmailAndPassword(userEmail, userPaswd).addOnCompleteListener(ActivityLogin.this, new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if (!task.isSuccessful()) {
                                Toast.makeText(ActivityLogin.this, "Not sucessful", Toast.LENGTH_SHORT).show();
                            } else {
                                startActivity(new Intent("com.example.myapplication.Link"));
                            }
                        }
                    });
                } else {
